...
REQUIRED_PATHS = (
    ...
    ".gitignore",
    "CONTRIBUTING.md",
    "lab/governance/PROJECT_DOCTRINE.md",
    "lab/governance/REPOSITORY_ARCHITECTURE.md",
    "lab/governance/AI_RETRIEVAL_PROTOCOL.md",
    "lab/governance/RIGHTS_AND_ASSET_BOUNDARIES.md",
    "lab/governance/BLENDER_REPRODUCIBILITY.md",
    "lab/governance/LICENSING_STATUS.md",
    "lab/governance/SCHEMA_LIFECYCLE.md",
    "lab/governance/BINARY_ASSET_POLICY.md",
    "lab/governance/OPERATIONAL_BASELINE.md",
    "workflows/README.md",
    ...
    "lab/experiments/TEMPLATE.md",
    "lab/schemas/experiment.schema.json",
    "lab/schemas/evidence.schema.json",
    "lab/schemas/observation.schema.json",
    "lab/schemas/source-asset.schema.json",
    "lab/schemas/transformation.schema.json",
    "lab/schemas/unknown-field.schema.json",
    "lab/schemas/claim.schema.json",
    "lab/schemas/node-contract.schema.json",
    "lab/schemas/camera-pipeline.schema.json",
    "lab/schemas/blender-run.schema.json",
    "lab/schemas/blender-toolchain.schema.json",
    "lab/schemas/binary-fixture.schema.json",
    "lab/schemas/mesh-report.schema.json",
    "lab/schemas/canonical-artifact.schema.json",
    "lab/schemas/master-index.schema.json",
    "research/automotive_materials/Automotive_Body_RnD_Master.md",
    "research/automotive_materials/master.provenance.json",
    ...
    "src/virtualauto/lensfun_models.py",
    ...
    "workflows/blender/scripts/build_lensfun_maps.py",
    "workflows/blender/scripts/test_mapuv_identity.py",
    ...
    "dev/tests/test_lensfun_models.py",
...
def validate_required_structure() -> None:
    ...
    retired = sorted(
        name for name in RETIRED_TOP_LEVEL_DIRECTORIES if (ROOT / name).exists()
    )
    if retired:
        fail(f"Retired top-level directories returned: {', '.join(retired)}")
...
def validate_master_index() -> None:
    provenance = read_json(
        ROOT / "research/automotive_materials/master.provenance.json"
    )
    index = read_json(ROOT / "research/indexes/automotive_master.index.json")
    expected = {
